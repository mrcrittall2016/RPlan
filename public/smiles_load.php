<?php
    ...
    $rows = Database::query("SELECT * FROM `main_rplanner`. `reactions` WHERE Scheme_name = ?", $scheme_number);
    ...
    foreach ($compounds as $compound){
        ...
        $rows = Database::query("SELECT * FROM `main_rplanner`. `cmpds` WHERE id = ?", $compound);
