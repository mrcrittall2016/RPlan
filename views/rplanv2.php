                     ...
                     $('#submit_scheme').click(function(){
                      	...
                      	$.getJSON("scheme_check.php", scheme_id).done(function(data, textStatus, jqXHR){
                              ...
                              if (data.result == false){
                                    ...
                                    console.log("id does not already exist");
                                  ...
                                  console.log("sorry, id already taken!"); 
