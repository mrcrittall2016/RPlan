    ...
    document.getElementById("generate").addEventListener("click", function(event){        
        ...
        function pages(step){            
            ...
            this.html = function(){
                ...
                /*
                "<div id ='wrapper' class = 'insert'><div id = 'box'><div id='jsme_container1'></div></div><div id = 'field-wrap'><div class='form-groups' style = 'width:150px;'><input autocomplete='off' class =" + "'" + this.step + "'"  + "autofocus class='form-control' name='moles' placeholder='Moles' type='text'readonly/></div><div class='form-groups' style = 'width:150px; padding-top:5px;'><input autocomplete='off' class =" + "'" + this.step + "'" + "autofocus class='form-control' name='smiles' placeholder='Smiles' type='text' readonly/></div><div class='form-groups' style = 'width:150px; padding-top:5px;'><input autocomplete='off' class =" + "'" + this.step + "'" + "autofocus class='form-control' name='MW' placeholder='Molecular Weight' type='text' readonly/></div>"; 
                */
                
                "<div class='container-fluid bg-1'> <div id=‘wrapper’> <div id=‘box’> <div id=‘jsme_container1’></div> </div> <div id='field-wrap' style='height:130px;'> <form role=‘form’> <div class=‘form-group’> <input type='text' class=‘form-control input-sm’ id=‘moles_start’ autocomplete='off' class =" + "'" + this.step + "'" + "autofocus class='form-control' name='moles' placeholder='Moles' readonly/> </div> <div class=‘form-group’> <input type='text' class=‘form-control input-sm’ autocomplete='off' class =" + "'" + this.step + "'" + "autofocus class='form-control' name='smiles' placeholder='Smiles' readonly/> </div> <div class=‘form-group’> <input type='text' class=‘form-control input-sm’ autocomplete='off' class =" + "'" + this.step + "'" + "autofocus class='form-control' name='MW' placeholder='Molecular Weight' readonly/> </div> </form> </div> </div> </div>"
            ...
            this.arrow = function(){
                ...
                */
                ...
                "<div class='container-fluid bg-1'> <div id='yield_wrap'> <div id='field-wrap' style='height:40px;'> <div class='form-groups'> <input autocomplete='off' class =" + "'" + this.step + "'"  + "autofocus class='form-control' name='yield' placeholder='yield' type='text'/> </div> </div> </div> </div>"; 
            };
