...
<html lang = "en">
    <head>     
        ...
        <link href="/css/index.1.css?parameter=4" rel="stylesheet"/>  
          ...
          <div class="carousel-inner height" role="listbox">
            <div class="item active">
              ...
              <div class="carousel-caption">
                <h3>RPlan</h3>
                <h4>Accurately plan your synthetic route to meet client demands</h4>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="carousel-caption">
                <h3>RScheme</h3>
                <h4>Demonstrate synthetic progress to client and project managers</h4>
              </div>
            </div> 
          </div>
